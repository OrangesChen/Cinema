...
- (void)updateDeviceOrientation
{
    if (self.motionManager.deviceMotionAvailable)
    {
        ...
        /*
         每个人都有自己对于哪个视图坐标空间最直观的看法，但我总是选择一个右手系统，+ Y 向上，+ X 向右，+ Z 
         向观察者。这不同于 Core Motion 的约定，因此为了使用设备定向数据，我们按以下方式解释CoreMotion
         轴:CoreMotion的 X 轴成为我们的世界的 Z 轴，Z 成为 Y，Y 成为 X.我们没有以镜像为任 何轴，因为 
         CoreMotion 的参考框架都是右手的。
         */
...
//        vector_float4 X = { m.m11, m.m21, m.m31, 0 };
//        vector_float4 Y = { m.m12, m.m22, m.m32, 0 };
//        vector_float4 Z = { m.m13, m.m23, m.m33, 0 };
//        vector_float4 W = {     0,     0,     0, 1 };
